...
# load data
#rawdata=read.csv("imf1.csv",header=T)
#rawdata=read.csv("imf2.csv",header=T)
#rawdata=read.csv("imf3.csv",header=T)
#rawdata=read.csv("imf4.csv",header=T)
#rawdata=read.csv("imf5.csv",header=T)
rawdata=read.csv("imf6.csv",header=T)
